...
real(C_DOUBLE), dimension(:, :, :), allocatable :: r,rho,ux,uy,uz,u2,rho_ux,rho_uy,rho_uz
real(C_DOUBLE), dimension(:, :, :), allocatable :: jx,jy,jz,Ax,Ay,Az,j2,A2,omega_x,omega_y,omega_z,omega2
real(C_DOUBLE), dimension(:, :, :), allocatable :: P,E,Bx,By,Bz,B2,div_B,rho_dum,ux_dum,uy_dum,uz_dum
real(C_DOUBLE), dimension(:, :, :), allocatable :: rho_ux_dum,rho_uy_dum,rho_uz_dum,P_dum,E_dum,Bx_dum,By_dum,Bz_dum

real(C_DOUBLE), dimension(:, :, :), allocatable :: Mom_x_1,Mom_x_2,Mom_x_3,Mom_y_1,Mom_y_2,Mom_y_3,Mom_z_1,Mom_z_2,Mom_z_3
real(C_DOUBLE), dimension(:, :, :), allocatable :: d_ux_dx,d_uy_dy,d_uz_dz,Fx,Fy,Fz,Energy_x,Energy_y,Energy_z,E_Visc
real(C_DOUBLE), dimension(:, :, :), allocatable :: Mag_x_1,Mag_x_2,Mag_y_1,Mag_y_2,Mag_z_1,Mag_z_2
real(C_DOUBLE), dimension(:, :, :), allocatable :: d_Bx_dy,d_By_dx,d_Bx_dz,d_By_dz,d_Bz_dx,d_Bz_dy,curl_x_B,curl_y_B,curl_z_B

complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: rho_k,ux_k,uy_k,uz_k,rho_ux_k,rho_uy_k,rho_uz_k
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: omega_x_k,omega_y_k,omega_z_k,jx_k,jy_k,jz_k,Ax_k,Ay_k,Az_k
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: P_k,E_k,Ek,Bk,Bx_k,By_k,Bz_k,div_B_k,rho_k_dum
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: ux_k_dum,uy_k_dum,uz_k_dum
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: omega_x_k_dum,omega_y_k_dum,omega_z_k_dum
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: rho_ux_k_dum,rho_uy_k_dum,rho_uz_k_dum
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: E_k_dum,Bx_k_dum,By_k_dum,Bz_k_dum
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: rho_k_new,rho_ux_k_new,rho_uy_k_new,rho_uz_k_new
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: E_k_new,Bx_k_new,By_k_new,Bz_k_new

complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: d_rho_k_dt_old,d_rho_ux_k_dt_old,d_rho_uy_k_dt_old,d_rho_uz_k_dt_old
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: d_E_k_dt_old,d_Bx_k_dt_old,d_By_k_dt_old,d_Bz_k_dt_old
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: d_rho_k_dt_new,d_rho_ux_k_dt_new,d_rho_uy_k_dt_new,d_rho_uz_k_dt_new
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: d_E_k_dt_new,d_Bx_k_dt_new,d_By_k_dt_new,d_Bz_k_dt_new

complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: nu,Fx_k,Fy_k,Fz_k
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: i_kx_rho_ux_k,i_ky_rho_uy_k,i_kz_rho_uz_k
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: Mom_x_1_k,Mom_x_2_k,Mom_x_3_k
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: Mom_y_1_k,Mom_y_2_k,Mom_y_3_k
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: Mom_z_1_k,Mom_z_2_k,Mom_z_3_k
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: i_kx_Mom_x_1_k,i_ky_Mom_x_2_k,i_kz_Mom_x_3_k
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: i_kx_Mom_y_1_k,i_ky_Mom_y_2_k,i_kz_Mom_y_3_k
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: i_kx_Mom_z_1_k,i_ky_Mom_z_2_k,i_kz_Mom_z_3_k
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: kx2_ux_k,ky2_ux_k,kz2_ux_k,kx2_uy_k,ky2_uy_k
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: kz2_uy_k,kx2_uz_k,ky2_uz_k,kz2_uz_k
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: i_kx_ux_k,i_ky_uy_k,i_kz_uz_k
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: Energy_x_k,Energy_y_k,Energy_z_k,E_Visc_k
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: Mag_x_1_k,Mag_x_2_k,Mag_y_1_k,Mag_y_2_k
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: Mag_z_1_k,Mag_z_2_k
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: i_kx_Energy_x_k,i_ky_Energy_y_k,i_kz_Energy_z_k
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: i_ky_Mag_x_1_k,i_kz_Mag_x_2_k,i_kx_Mag_y_1_k
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: i_kz_Mag_y_2_k,i_kx_Mag_z_1_k,i_ky_Mag_z_2_k
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: i_ky_Bx_k,i_kx_By_k,i_kx_Bz_k
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: i_kz_Bx_k,i_ky_Bz_k,i_kz_By_k
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: kx2_Bx_k,ky2_Bx_k,kz2_Bx_k,kx2_By_k,ky2_By_k
complex(C_DOUBLE_COMPLEX), dimension(:, :, :), allocatable :: kz2_By_k,kx2_Bz_k,ky2_Bz_k,kz2_Bz_k
...
allocate(r(Nx, Ny, Nz/nproc))
allocate(rho(Nx, Ny, Nz/nproc))
allocate(ux(Nx, Ny, Nz/nproc))
allocate(uy(Nx, Ny, Nz/nproc))
allocate(uz(Nx, Ny, Nz/nproc))
allocate(u2(Nx, Ny, Nz/nproc))
allocate(rho_ux(Nx, Ny, Nz/nproc))
allocate(rho_uy(Nx, Ny, Nz/nproc))
allocate(rho_uz(Nx, Ny, Nz/nproc))

allocate(jx(Nx, Ny, Nz/nproc))
allocate(jy(Nx, Ny, Nz/nproc))
allocate(jz(Nx, Ny, Nz/nproc))
allocate(Ax(Nx, Ny, Nz/nproc))
allocate(Ay(Nx, Ny, Nz/nproc))
allocate(Az(Nx, Ny, Nz/nproc))
allocate(j2(Nx, Ny, Nz/nproc))
allocate(A2(Nx, Ny, Nz/nproc))
allocate(omega_x(Nx, Ny, Nz/nproc))
allocate(omega_y(Nx, Ny, Nz/nproc))
allocate(omega_z(Nx, Ny, Nz/nproc))
allocate(omega2(Nx, Ny, Nz/nproc))

allocate(P(Nx, Ny, Nz/nproc))
allocate(E(Nx, Ny, Nz/nproc))
allocate(Bx(Nx, Ny, Nz/nproc))
allocate(By(Nx, Ny, Nz/nproc))
allocate(Bz(Nx, Ny, Nz/nproc))
allocate(B2(Nx, Ny, Nz/nproc))
allocate(div_B(Nx, Ny, Nz/nproc))
allocate(rho_dum(Nx, Ny, Nz/nproc))
allocate(ux_dum(Nx, Ny, Nz/nproc))
allocate(uy_dum(Nx, Ny, Nz/nproc))
allocate(uz_dum(Nx, Ny, Nz/nproc))

allocate(rho_ux_dum(Nx, Ny, Nz/nproc))
allocate(rho_uy_dum(Nx, Ny, Nz/nproc))
allocate(rho_uz_dum(Nx, Ny, Nz/nproc))
allocate(P_dum(Nx, Ny, Nz/nproc))
allocate(E_dum(Nx, Ny, Nz/nproc))
allocate(Bx_dum(Nx, Ny, Nz/nproc))
allocate(By_dum(Nx, Ny, Nz/nproc))
allocate(Bz_dum(Nx, Ny, Nz/nproc))

allocate(Mom_x_1(Nx, Ny, Nz/nproc))
allocate(Mom_x_2(Nx, Ny, Nz/nproc))
allocate(Mom_x_3(Nx, Ny, Nz/nproc))
allocate(Mom_y_1(Nx, Ny, Nz/nproc))
allocate(Mom_y_2(Nx, Ny, Nz/nproc))
allocate(Mom_y_3(Nx, Ny, Nz/nproc))
allocate(Mom_z_1(Nx, Ny, Nz/nproc))
allocate(Mom_z_2(Nx, Ny, Nz/nproc))
allocate(Mom_z_3(Nx, Ny, Nz/nproc))

allocate(d_ux_dx(Nx, Ny, Nz/nproc))
allocate(d_uy_dy(Nx, Ny, Nz/nproc))
allocate(d_uz_dz(Nx, Ny, Nz/nproc))
allocate(Fx(Nx, Ny, Nz/nproc))
allocate(Fy(Nx, Ny, Nz/nproc))
allocate(Fz(Nx, Ny, Nz/nproc))
allocate(Energy_x(Nx, Ny, Nz/nproc))
allocate(Energy_y(Nx, Ny, Nz/nproc))
allocate(Energy_z(Nx, Ny, Nz/nproc))
allocate(E_Visc(Nx, Ny, Nz/nproc))

allocate(Mag_x_1(Nx, Ny, Nz/nproc))
allocate(Mag_x_2(Nx, Ny, Nz/nproc))
allocate(Mag_y_1(Nx, Ny, Nz/nproc))
allocate(Mag_y_2(Nx, Ny, Nz/nproc))
allocate(Mag_z_1(Nx, Ny, Nz/nproc))
allocate(Mag_z_2(Nx, Ny, Nz/nproc))

allocate(d_Bx_dy(Nx, Ny, Nz/nproc))
allocate(d_By_dx(Nx, Ny, Nz/nproc))
allocate(d_Bx_dz(Nx, Ny, Nz/nproc))
allocate(d_By_dz(Nx, Ny, Nz/nproc))
allocate(d_Bz_dx(Nx, Ny, Nz/nproc))
allocate(d_Bz_dy(Nx, Ny, Nz/nproc))
allocate(curl_x_B(Nx, Ny, Nz/nproc))
allocate(curl_y_B(Nx, Ny, Nz/nproc))
allocate(curl_z_B(Nx, Ny, Nz/nproc))

allocate(rho_k(Nh, Ny, Nz/nproc))
allocate(ux_k(Nh, Ny, Nz/nproc))
allocate(uy_k(Nh, Ny, Nz/nproc))
allocate(uz_k(Nh, Ny, Nz/nproc))
allocate(rho_ux_k(Nh, Ny, Nz/nproc))
allocate(rho_uy_k(Nh, Ny, Nz/nproc))
allocate(rho_uz_k(Nh, Ny, Nz/nproc))

allocate(omega_x_k(Nh, Ny, Nz/nproc))
allocate(omega_y_k(Nh, Ny, Nz/nproc))
allocate(omega_z_k(Nh, Ny, Nz/nproc))
allocate(jx_k(Nh, Ny, Nz/nproc))
allocate(jy_k(Nh, Ny, Nz/nproc))
allocate(jz_k(Nh, Ny, Nz/nproc))
allocate(Ax_k(Nh, Ny, Nz/nproc))
allocate(Ay_k(Nh, Ny, Nz/nproc))
allocate(Az_k(Nh, Ny, Nz/nproc))

allocate(P_k(Nh, Ny, Nz/nproc))
allocate(E_k(Nh, Ny, Nz/nproc))
allocate(Ek(Nh, Ny, Nz/nproc))
allocate(Bk(Nh, Ny, Nz/nproc))
allocate(Bx_k(Nh, Ny, Nz/nproc))
allocate(By_k(Nh, Ny, Nz/nproc))
allocate(Bz_k(Nh, Ny, Nz/nproc))
allocate(div_B_k(Nh, Ny, Nz/nproc))
allocate(rho_k_dum(Nh, Ny, Nz/nproc))
allocate(ux_k_dum(Nh, Ny, Nz/nproc))
allocate(uy_k_dum(Nh, Ny, Nz/nproc))
allocate(uz_k_dum(Nh, Ny, Nz/nproc))
allocate(omega_x_k_dum(Nh, Ny, Nz/nproc))
allocate(omega_y_k_dum(Nh, Ny, Nz/nproc))
allocate(omega_z_k_dum(Nh, Ny, Nz/nproc))
allocate(rho_ux_k_dum(Nh, Ny, Nz/nproc))
allocate(rho_uy_k_dum(Nh, Ny, Nz/nproc))
allocate(rho_uz_k_dum(Nh, Ny, Nz/nproc))
allocate(E_k_dum(Nh, Ny, Nz/nproc))
allocate(Bx_k_dum(Nh, Ny, Nz/nproc))
allocate(By_k_dum(Nh, Ny, Nz/nproc))
allocate(Bz_k_dum(Nh, Ny, Nz/nproc))
allocate(rho_k_new(Nh, Ny, Nz/nproc))
allocate(rho_ux_k_new(Nh, Ny, Nz/nproc))
allocate(rho_uy_k_new(Nh, Ny, Nz/nproc))
allocate(rho_uz_k_new(Nh, Ny, Nz/nproc))
allocate(E_k_new(Nh, Ny, Nz/nproc))
allocate(Bx_k_new(Nh, Ny, Nz/nproc))
allocate(By_k_new(Nh, Ny, Nz/nproc))
allocate(Bz_k_new(Nh, Ny, Nz/nproc))

allocate(d_rho_k_dt_old(Nh, Ny, Nz/nproc))
allocate(d_rho_ux_k_dt_old(Nh, Ny, Nz/nproc))
allocate(d_rho_uy_k_dt_old(Nh, Ny, Nz/nproc))
allocate(d_rho_uz_k_dt_old(Nh, Ny, Nz/nproc))
allocate(d_E_k_dt_old(Nh, Ny, Nz/nproc))
allocate(d_Bx_k_dt_old(Nh, Ny, Nz/nproc))
allocate(d_By_k_dt_old(Nh, Ny, Nz/nproc))
allocate(d_Bz_k_dt_old(Nh, Ny, Nz/nproc))
allocate(d_rho_k_dt_new(Nh, Ny, Nz/nproc))
allocate(d_rho_ux_k_dt_new(Nh, Ny, Nz/nproc))
allocate(d_rho_uy_k_dt_new(Nh, Ny, Nz/nproc))
allocate(d_rho_uz_k_dt_new(Nh, Ny, Nz/nproc))
allocate(d_E_k_dt_new(Nh, Ny, Nz/nproc))
allocate(d_Bx_k_dt_new(Nh, Ny, Nz/nproc))
allocate(d_By_k_dt_new(Nh, Ny, Nz/nproc))
allocate(d_Bz_k_dt_new(Nh, Ny, Nz/nproc))

allocate(nu(Nh, Ny, Nz/nproc))
allocate(Fx_k(Nh, Ny, Nz/nproc))
allocate(Fy_k(Nh, Ny, Nz/nproc))
allocate(Fz_k(Nh, Ny, Nz/nproc))
allocate(i_kx_rho_ux_k(Nh, Ny, Nz/nproc))
allocate(i_ky_rho_uy_k(Nh, Ny, Nz/nproc))
allocate(i_kz_rho_uz_k(Nh, Ny, Nz/nproc))
allocate(Mom_x_1_k(Nh, Ny, Nz/nproc))
allocate(Mom_x_2_k(Nh, Ny, Nz/nproc))
allocate(Mom_x_3_k(Nh, Ny, Nz/nproc))
allocate(Mom_y_1_k(Nh, Ny, Nz/nproc))
allocate(Mom_y_2_k(Nh, Ny, Nz/nproc))
allocate(Mom_y_3_k(Nh, Ny, Nz/nproc))
allocate(Mom_z_1_k(Nh, Ny, Nz/nproc))
allocate(Mom_z_2_k(Nh, Ny, Nz/nproc))
allocate(Mom_z_3_k(Nh, Ny, Nz/nproc))
allocate(i_kx_Mom_x_1_k(Nh, Ny, Nz/nproc))
allocate(i_ky_Mom_x_2_k(Nh, Ny, Nz/nproc))
allocate(i_kz_Mom_x_3_k(Nh, Ny, Nz/nproc))
allocate(i_kx_Mom_y_1_k(Nh, Ny, Nz/nproc))
allocate(i_ky_Mom_y_2_k(Nh, Ny, Nz/nproc))
allocate(i_kz_Mom_y_3_k(Nh, Ny, Nz/nproc))
allocate(i_kx_Mom_z_1_k(Nh, Ny, Nz/nproc))
allocate(i_ky_Mom_z_2_k(Nh, Ny, Nz/nproc))
allocate(i_kz_Mom_z_3_k(Nh, Ny, Nz/nproc))
allocate(kx2_ux_k(Nh, Ny, Nz/nproc))
allocate(ky2_ux_k(Nh, Ny, Nz/nproc))
allocate(kz2_ux_k(Nh, Ny, Nz/nproc))
allocate(kx2_uy_k(Nh, Ny, Nz/nproc))
allocate(ky2_uy_k(Nh, Ny, Nz/nproc))
allocate(kz2_uy_k(Nh, Ny, Nz/nproc))
allocate(kx2_uz_k(Nh, Ny, Nz/nproc))
allocate(ky2_uz_k(Nh, Ny, Nz/nproc))
allocate(kz2_uz_k(Nh, Ny, Nz/nproc))
allocate(i_kx_ux_k(Nh, Ny, Nz/nproc))
allocate(i_ky_uy_k(Nh, Ny, Nz/nproc))
allocate(i_kz_uz_k(Nh, Ny, Nz/nproc))
allocate(Energy_x_k(Nh, Ny, Nz/nproc))
allocate(Energy_y_k(Nh, Ny, Nz/nproc))
allocate(Energy_z_k(Nh, Ny, Nz/nproc))
allocate(E_Visc_k(Nh, Ny, Nz/nproc))
allocate(Mag_x_1_k(Nh, Ny, Nz/nproc))
allocate(Mag_x_2_k(Nh, Ny, Nz/nproc))
allocate(Mag_y_1_k(Nh, Ny, Nz/nproc))
allocate(Mag_y_2_k(Nh, Ny, Nz/nproc))
allocate(Mag_z_1_k(Nh, Ny, Nz/nproc))
allocate(Mag_z_2_k(Nh, Ny, Nz/nproc))
allocate(i_kx_Energy_x_k(Nh, Ny, Nz/nproc))
allocate(i_ky_Energy_y_k(Nh, Ny, Nz/nproc))
allocate(i_kz_Energy_z_k(Nh, Ny, Nz/nproc))
allocate(i_ky_Mag_x_1_k(Nh, Ny, Nz/nproc))
allocate(i_kz_Mag_x_2_k(Nh, Ny, Nz/nproc))
allocate(i_kx_Mag_y_1_k(Nh, Ny, Nz/nproc))
allocate(i_kz_Mag_y_2_k(Nh, Ny, Nz/nproc))
allocate(i_kx_Mag_z_1_k(Nh, Ny, Nz/nproc))
allocate(i_ky_Mag_z_2_k(Nh, Ny, Nz/nproc))
allocate(i_ky_Bx_k(Nh, Ny, Nz/nproc))
allocate(i_kx_By_k(Nh, Ny, Nz/nproc))
allocate(i_kx_Bz_k(Nh, Ny, Nz/nproc))
allocate(i_kz_Bx_k(Nh, Ny, Nz/nproc))
allocate(i_ky_Bz_k(Nh, Ny, Nz/nproc))
allocate(i_kz_By_k(Nh, Ny, Nz/nproc))
allocate(kx2_Bx_k(Nh, Ny, Nz/nproc))
allocate(ky2_Bx_k(Nh, Ny, Nz/nproc))
allocate(kz2_Bx_k(Nh, Ny, Nz/nproc))
allocate(kx2_By_k(Nh, Ny, Nz/nproc))
allocate(ky2_By_k(Nh, Ny, Nz/nproc))
allocate(kz2_By_k(Nh, Ny, Nz/nproc))
allocate(kx2_Bz_k(Nh, Ny, Nz/nproc))
allocate(ky2_Bz_k(Nh, Ny, Nz/nproc))
allocate(kz2_Bz_k(Nh, Ny, Nz/nproc))
...
do i = 1, Nx
  do j = 1, Ny
    do k = 1, Nz/nproc
      ...
      ux(i,j,k) = U0 * ( A*dsin(kf*z(k+((Nz/nproc)*myid))) + C*dcos(kf*y(j)) )
      uy(i,j,k) = U0 * ( B*dsin(kf*x(i)) + A*dcos(kf*z(k+((Nz/nproc)*myid))) )
      uz(i,j,k) = U0 * ( C*dsin(kf*y(j)) + B*dcos(kf*x(i)) )
      ! Initial Pressure Distribution.
      P(i,j,k) = P0
      ! Initial Magnetic Field Profile.
      Bx(i,j,k) = B0!*(A*dsin(kf*z(k+((Nz/nproc)*myid))) + C*dcos(kf*y(j)))
      By(i,j,k) = B0!*(B*dsin(kf*x(i)) + A*dcos(kf*z(k+((Nz/nproc)*myid))))
      ...
      ! Evaluate Forcing.
      Fx(i,j,k) = rho(i,j,k) * ( A*dsin(kf*z(k+((Nz/nproc)*myid))) + C*dcos(kf*y(j)) )
      Fy(i,j,k) = rho(i,j,k) * ( B*dsin(kf*x(i)) + A*dcos(kf*z(k+((Nz/nproc)*myid))) )
...
do i = 1, Nx
  do j = 1, Ny
    do k = 1, Nz/nproc
      ...
      write(15+myid,*) ux(i,j,k),uy(i,j,k),uz(i,j,k),Bx(i,j,k),By(i,j,k),Bz(i,j,k)
    enddo
  end do
end do
