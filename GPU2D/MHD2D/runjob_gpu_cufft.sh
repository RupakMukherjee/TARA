...
pgf95 -fast -c -Minfo=accel -ta=tesla:cc60,managed PSMHD2-cufftacc.f95 -lm
...
pgf95 -fast -Minfo=accel -ta=tesla:cc60,managed -Mcudalib=cufft PSMHD2-cufftacc.o cufft2D.o -lm
