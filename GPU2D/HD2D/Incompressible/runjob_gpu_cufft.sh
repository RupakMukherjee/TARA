...
pgf95 -fast -c -Minfo=accel -ta=tesla:cc60,managed PSMHD3-cufftacc.f95 -lm
...
pgf95 -fast -Minfo=accel -ta=tesla:cc60,managed -Mcudalib=cufft PSMHD3-cufftacc.o cufft2D.o -lm
